...
function widgetFlotChart() {
  ...
  var flotChartData2 = [{ label: "Data 1", data: d1, color: "#19a0a1" }];
...
function CalendarCtrl($scope) {
  ...
  $scope.alertOnResize = function(
    ...
    $scope.alertMessage =
      event.title + ": Resized to make dayDelta " + minuteDelta;
  };
...
function toastrCtrl($scope, toaster) {
  $scope.demo1 = function() {
    toaster.success({
      body:
        "Hi, welcome to Inspinia. This is example of Toastr notification box."
    });
  };
