/**
 * modalSospensioneDomandaCtrl - controller
 * Controller per la finestra modale di sospensione domade
 *
 */
function modalSospensioneDomandaCtrl($scope) {
 ...
 **/
angular.module("inciso").controller("modalSospensioneDomandaCtrl", modalSospensioneDomandaCtrl);
