/**
 * modalRevocaDomandaCtrl - controller
 * Controller per la finestra modale di Revoca domade
 *
 */
function modalRevocaDomandaCtrl($scope) {
 ...
 **/
angular.module("inciso").controller("modalRevocaDomandaCtrl", modalRevocaDomandaCtrl);
